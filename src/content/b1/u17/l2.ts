...
export const b1u17l2: Lesson = {
  ...
  estMinutes: 20,
  vocab: [
    { id: "b1u17.televizija", image: "/img/televizija.png", hr: "televizija", en: "television", pos: "noun", gender: "f", icon: "📺", exampleHr: "Gledam vijesti na televiziji.", exampleEn: "I watch the news on TV." },
    { id: "b1u17.emisija", image: "/img/emisija.png", hr: "emisija", en: "TV show / programme", pos: "noun", gender: "f", icon: "🎬", exampleHr: "Voditelj je počeo emisiju u osam.", exampleEn: "The host started the show at eight." },
    { id: "b1u17.program", image: "/img/program.png", hr: "program", en: "programming / schedule", pos: "noun", gender: "m", icon: "🗓️", exampleHr: "Večeras je program dobar.", exampleEn: "Tonight the programming is good." },
    { id: "b1u17.kanal", image: "/img/kanal.png", hr: "kanal", en: "channel", pos: "noun", gender: "m", icon: "📡", exampleHr: "Koji kanal gledaš?", exampleEn: "Which channel are you watching?" },
    { id: "b1u17.voditelj", image: "/img/voditelj.png", hr: "voditelj", en: "host / presenter (m; voditeljica f)", pos: "noun", gender: "m", icon: "🎙️", exampleHr: "Voditelj je jako dobar.", exampleEn: "The host is very good." },
    { id: "b1u17.gledatelj", image: "/img/gledatelj.png", hr: "gledatelj", en: "viewer (m)", pos: "noun", gender: "m", icon: "👀", exampleHr: "Gledatelji vole emisiju.", exampleEn: "The viewers love the show." },
    { id: "b1u17.dizati", image: "/img/dizati.png", hr: "dizati", en: "to raise / lift (impf; dižem)", pos: "verb", icon: "🏋️", exampleHr: "Marko diže čašu.", exampleEn: "Marko is raising his glass." },
    { id: "b1u17.dignuti", image: "/img/dignuti.png", hr: "dignuti", en: "to raise (once) — pf; digao/digla!", pos: "verb", icon: "⬆️", exampleHr: "Digla je ruku.", exampleEn: "She raised her hand." },
    { id: "b1u17.dati", image: "/img/dati.png", hr: "dati", en: "to give (pf of davati; dam, dao)", pos: "verb", icon: "🎁", exampleHr: "Baka mi je dala novine.", exampleEn: "Grandma gave me the newspaper." },
  ],
  slides: [
    {
      id: "s01",
