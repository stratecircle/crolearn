...
export const b1u17test: UnitTest = {
    ...
    },
    {
      ...
      slides: [
        ...
        },
        {
          ...
          tts: "Televizija prenosi utakmicu svaku subotu.",
          options: ["a habit — every Saturday", "one single broadcast", "a plan for tomorrow"],
          correctIndex: 0,
          explanation: "prenosi (imperfective) + svaku subotu = repetition.",
        },
      ],
    },
    {
      ...
      slides: [
        {
          ...
          type: "mc",
          prompt:
            "»Jučer je bio velik događaj u Splitu. Dok su ljudi radili, digao se vjetar. Odjednom je palo drvo na trg. Ljudi su bili dobro. Portal je objavio prve fotografije u tri sata. Televizija je vijest prenijela navečer.«\n\nŠto se dogodilo na trgu? (What happened on the square?)",
        ...
        },
        {
          id: "s20",
          type: "mc",
          prompt: "Same text: Jesu li ljudi bili dobro? (Were the people okay?)",
          options: ["Da — ljudi su bili dobro.", "Ne — nisu bili dobro.", "Tekst ne govori.", "Samo konobar nije bio dobro."],
          correctIndex: 0,
          explanation: "»Ljudi su bili dobro.«",
        },
        {
          id: "s21",
          type: "mc",
          prompt: "Same text: Tko je prvi objavio fotografije — portal ili televizija?",
          options: ["Portal, u tri sata.", "Televizija, navečer.", "Radio, ujutro.", "Novine, sljedeći dan."],
          correctIndex: 0,
  ...
  writing: {
    ...
    maxWords: 150,
    modelHr:
      "Obično ujutro čitam portale na mobitelu, a navečer gledam televiziju. Uvijek slušam radio dok pijem kavu.\n\nJučer sam pročitao jako dug članak. Naslov je bio kratak, ali članak je bio dug. Onda sam pogledao jednu emisiju na televiziji.\n\nDok sam gledao emisiju, Ana je došla. Odjednom je počela kiša, i onda smo zajedno gledali vijesti. Voditelj je bio jako dobar.\n\nVečeras ću poslušati jednu emisiju na radiju i napisat ću poruku prijatelju. Neću gledati televiziju cijelu večer — samo jednu emisiju, a onda ću čitati časopis.",
    rubricFocus:
