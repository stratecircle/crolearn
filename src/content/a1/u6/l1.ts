...
export const a1u6l1: Lesson = {
  ...
  estMinutes: 18,
  vocab: [
    { id: "a1u6.buditi-se", hr: "buditi se", en: "to wake up (budim se)", pos: "verb", icon: "⏰", exampleHr: "Budim se rano.", exampleEn: "I wake up early." },
    { id: "a1u6.ustajati", hr: "ustajati", en: "to get up (ustajem — no se)", pos: "verb", icon: "🛏️", exampleHr: "Ustajem rano.", exampleEn: "I get up early." },
    { id: "a1u6.tusirati-se", hr: "tuširati se", en: "to shower (tuširam se)", pos: "verb", icon: "🚿", exampleHr: "Tuširam se kasno.", exampleEn: "I shower late." },
    { id: "a1u6.oblaciti-se", hr: "oblačiti se", en: "to get dressed (oblačim se)", pos: "verb", icon: "👕", exampleHr: "Oblačim se.", exampleEn: "I get dressed." },
    { id: "a1u6.odmarati-se", hr: "odmarati se", en: "to rest (odmaram se)", pos: "verb", icon: "😌", exampleHr: "Odmaram se.", exampleEn: "I rest." },
    { id: "a1u6.ici-spavati", hr: "ići spavati", en: "to go to bed (chunk)", pos: "phrase", icon: "🌙", exampleHr: "Idem spavati.", exampleEn: "I go to bed.", tags: ["chunk"] },
    { id: "a1u6.spavati", hr: "spavati", en: "to sleep (spavam)", pos: "verb", icon: "😴", exampleHr: "Spavam kasno.", exampleEn: "I sleep late." },
    { id: "a1u6.rano", hr: "rano", en: "early", pos: "adv", icon: "🌅", exampleHr: "Budim se rano.", exampleEn: "I wake up early." },
    { id: "a1u6.kasno", hr: "kasno", en: "late", pos: "adv", icon: "🌆", exampleHr: "Idem spavati kasno.", exampleEn: "I go to bed late." },
    { id: "a1u6.zatim", hr: "zatim", en: "then / next", pos: "adv", icon: "➡️", exampleHr: "Budim se, zatim se tuširam.", exampleEn: "I wake up, then I shower." },
  ],
  slides: [
    {
      id: "s01",
