...
export const a1u6l3: Lesson = {
  ...
  estMinutes: 18,
  vocab: [
    { id: "a1u6.film", hr: "film", en: "film / movie", pos: "noun", gender: "m", icon: "🎬", exampleHr: "Gledam filmove.", exampleEn: "I watch films." },
    { id: "a1u6.knjiga", hr: "knjiga", en: "book", pos: "noun", gender: "f", icon: "📖", exampleHr: "Volim knjige.", exampleEn: "I like books." },
    { id: "a1u6.pjesma", hr: "pjesma", en: "song", pos: "noun", gender: "f", icon: "🎵", exampleHr: "Slušam pjesme.", exampleEn: "I listen to songs." },
    { id: "a1u6.zadaca", hr: "zadaća", en: "homework", pos: "noun", gender: "f", icon: "📝", exampleHr: "Imam zadaću.", exampleEn: "I have homework." },
    { id: "a1u6.vijesti", hr: "vijesti", en: "news (f, always plural)", pos: "noun", gender: "f", icon: "📰", exampleHr: "Navečer gledam vijesti.", exampleEn: "In the evening I watch the news." },
    { id: "a1u6.sport", hr: "sport", en: "sport", pos: "noun", gender: "m", icon: "⚽", exampleHr: "Volim sport.", exampleEn: "I like sport." },
    { id: "a1u6.serija", hr: "serija", en: "TV series", pos: "noun", gender: "f", icon: "📺", exampleHr: "Ana voli serije.", exampleEn: "Ana likes series." },
    { id: "a1u6.slusati", hr: "slušati", en: "to listen (to) — slušam", pos: "verb", icon: "🎧", exampleHr: "Slušam pjesme.", exampleEn: "I listen to songs." },
    { id: "a1u6.uciti", hr: "učiti", en: "to study / learn — učim", pos: "verb", icon: "📚", exampleHr: "Učim jezike.", exampleEn: "I study languages." },
  ],
  slides: [
    {
      id: "s01",
