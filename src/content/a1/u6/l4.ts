...
export const a1u6l4: Lesson = {
  ...
  vocab: [
    { id: "a1u6.ponedjeljak", hr: "ponedjeljak", en: "Monday", pos: "noun", gender: "m", icon: "🗓️", exampleHr: "U ponedjeljak idem na posao.", exampleEn: "On Monday I go to work." },
    { id: "a1u6.utorak", hr: "utorak", en: "Tuesday", pos: "noun", gender: "m", icon: "📆", exampleHr: "U utorak učim hrvatski.", exampleEn: "On Tuesday I study Croatian." },
    { id: "a1u6.srijeda", hr: "srijeda", en: "Wednesday", pos: "noun", gender: "f", icon: "📅", exampleHr: "U srijedu gledam filmove.", exampleEn: "On Wednesday I watch films." },
    { id: "a1u6.cetvrtak", hr: "četvrtak", en: "Thursday", pos: "noun", gender: "m", icon: "🗓️", exampleHr: "U četvrtak slušam pjesme.", exampleEn: "On Thursday I listen to songs." },
    { id: "a1u6.petak", hr: "petak", en: "Friday", pos: "noun", gender: "m", icon: "🎉", exampleHr: "U petak gledam serije.", exampleEn: "On Friday I watch series." },
    { id: "a1u6.subota", hr: "subota", en: "Saturday", pos: "noun", gender: "f", icon: "🛌", exampleHr: "U subotu se odmaram.", exampleEn: "On Saturday I rest." },
    { id: "a1u6.nedjelja", hr: "nedjelja", en: "Sunday", pos: "noun", gender: "f", icon: "⛪", exampleHr: "U nedjelju spavam.", exampleEn: "On Sunday I sleep." },
    { id: "a1u6.uvijek", hr: "uvijek", en: "always", pos: "adv", icon: "🔥", exampleHr: "Uvijek pijem kavu ujutro.", exampleEn: "I always drink coffee in the morning." },
    { id: "a1u6.cesto", hr: "često", en: "often", pos: "adv", icon: "🔆", exampleHr: "Često gledam filmove.", exampleEn: "I often watch films." },
    { id: "a1u6.ponekad", hr: "ponekad", en: "sometimes", pos: "adv", icon: "🔁", exampleHr: "Ponekad slušam vijesti.", exampleEn: "Sometimes I listen to the news." },
    { id: "a1u6.rijetko", hr: "rijetko", en: "rarely / seldom", pos: "adv", icon: "🌙", exampleHr: "Rijetko gledam sport.", exampleEn: "I rarely watch sport." },
    { id: "a1u6.nikad", hr: "nikad", en: "never (needs ne!)", pos: "adv", icon: "❄️", exampleHr: "Nikad ne učim navečer.", exampleEn: "I never study in the evening." },
    { id: "a1u6.svaki-dan", hr: "svaki dan", en: "every day (chunk)", pos: "phrase", icon: "🔄", exampleHr: "Svaki dan pijem kavu.", exampleEn: "Every day I drink coffee.", tags: ["chunk"] },
    { id: "a1u6.tjedan", hr: "tjedan", en: "week", pos: "noun", gender: "m", icon: "📆", exampleHr: "Tjedan ima sedam dana.", exampleEn: "A week has seven days." },
  ],
  slides: [
    {
      id: "s01",
