...
export const a1u6l2: Lesson = {
  ...
  estMinutes: 19,
  vocab: [
    { id: "a1u6.sat", image: "/img/sat.png", hr: "sat", en: "hour / o'clock / clock", pos: "noun", gender: "m", icon: "🕐", exampleHr: "Jedan je sat.", exampleEn: "It's one o'clock." },
    { id: "a1u6.minuta", image: "/img/minuta.png", hr: "minuta", en: "minute", pos: "noun", gender: "f", icon: "⏱️", exampleHr: "Jedna minuta.", exampleEn: "One minute." },
    { id: "a1u6.pola", image: "/img/pola.png", hr: "pola", en: "half (to the next hour!)", pos: "noun", icon: "🕧", exampleHr: "Pola osam je 7:30.", exampleEn: "»Pola osam« is 7:30." },
    { id: "a1u6.podne", image: "/img/podne.png", hr: "podne", en: "noon / midday", pos: "noun", gender: "n", icon: "☀️", exampleHr: "Ručam u podne.", exampleEn: "I have lunch at noon." },
    { id: "a1u6.ponoc", image: "/img/ponoc.png", hr: "ponoć", en: "midnight", pos: "noun", gender: "f", icon: "🌑", exampleHr: "Idem spavati u ponoć.", exampleEn: "I go to bed at midnight." },
    { id: "a1u6.vrijeme", image: "/img/vrijeme.png", hr: "vrijeme", en: "time (also: weather)", pos: "noun", gender: "n", icon: "⏰", exampleHr: "Koliko je sati? — Vrijeme je za kavu!", exampleEn: "What time is it? — It's time for coffee!" },
    { id: "a1u6.ujutro", image: "/img/ujutro.png", hr: "ujutro", en: "in the morning", pos: "adv", icon: "🌄", exampleHr: "Budim se rano ujutro.", exampleEn: "I wake up early in the morning." },
    { id: "a1u6.prijepodne", image: "/img/prijepodne.png", hr: "prijepodne", en: "in the (late) morning / before noon", pos: "adv", icon: "🌤️", exampleHr: "Prijepodne pijem kavu.", exampleEn: "Before noon I drink coffee." },
    { id: "a1u6.popodne", image: "/img/popodne.png", hr: "popodne", en: "in the afternoon", pos: "adv", icon: "🌇", exampleHr: "Popodne se odmaram.", exampleEn: "In the afternoon I rest." },
    { id: "a1u6.navecer", image: "/img/navecer.png", hr: "navečer", en: "in the evening", pos: "adv", icon: "🌆", exampleHr: "Navečer idem spavati.", exampleEn: "In the evening I go to bed." },
  ],
  slides: [
    {
      id: "s01",
