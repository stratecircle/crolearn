...
export const a1u1l2: Lesson = {
  ...
  estMinutes: 17,
  vocab: [
    { id: "a1u1.caj", hr: "čaj", en: "tea", pos: "noun", gender: "m", icon: "🍵", image: "/img/caj.png", exampleHr: "Čaj i kava.", exampleEn: "Tea and coffee." },
    { id: "a1u1.covjek", hr: "čovjek", en: "person / man", pos: "noun", gender: "m", icon: "🧍", image: "/img/covjek.png", exampleHr: "Žena i čovjek.", exampleEn: "A woman and a man." },
    { id: "a1u1.dak", hr: "đak", en: "pupil", pos: "noun", gender: "m", icon: "🎒", image: "/img/dak.png", exampleHr: "On je đak.", exampleEn: "He is a pupil." },
    { id: "a1u1.dzep", hr: "džep", en: "pocket", pos: "noun", gender: "m", icon: "👖", image: "/img/dzep.png", exampleHr: "Njegov džep.", exampleEn: "His pocket." },
    { id: "a1u1.ljeto", hr: "ljeto", en: "summer", pos: "noun", gender: "n", icon: "☀️", image: "/img/ljeto.png", exampleHr: "To je ljeto.", exampleEn: "That is summer." },
    { id: "a1u1.njegov", hr: "njegov", en: "his", pos: "pron", exampleHr: "Njegov čaj.", exampleEn: "His tea." },
    { id: "a1u1.skola", hr: "škola", en: "school", pos: "noun", gender: "f", icon: "🏫", image: "/img/skola.png", exampleHr: "To je škola.", exampleEn: "That is a school." },
    { id: "a1u1.zena", hr: "žena", en: "woman / wife", pos: "noun", gender: "f", icon: "👩", image: "/img/zena.png", exampleHr: "Žena i čovjek.", exampleEn: "A woman and a man." },
    { id: "a1u1.cao", hr: "ćao", en: "hi / bye (casual)", pos: "interj", icon: "👋", exampleHr: "Ćao! Kako si?", exampleEn: "Hi! How are you?", tags: ["greeting"] },
    { id: "a1u1.hrvatska", hr: "Hrvatska", en: "Croatia", pos: "noun", gender: "f", icon: "🇭🇷", image: "/img/hrvatska.png", exampleHr: "To je Hrvatska.", exampleEn: "That is Croatia." },
  ],
  slides: [
    {
      id: "s01",
