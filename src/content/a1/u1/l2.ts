...
export const a1u1l2: Lesson = {
  ...
  estMinutes: 17,
  vocab: [
    { id: "a1u1.caj", image: "/img/caj.png", hr: "čaj", en: "tea", pos: "noun", gender: "m", icon: "🍵", exampleHr: "Čaj i kava.", exampleEn: "Tea and coffee." },
    { id: "a1u1.covjek", image: "/img/covjek.png", hr: "čovjek", en: "person / man", pos: "noun", gender: "m", icon: "🧍", exampleHr: "Žena i čovjek.", exampleEn: "A woman and a man." },
