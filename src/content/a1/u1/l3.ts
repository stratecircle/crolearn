...
export const a1u1l3: Lesson = {
  ...
  estMinutes: 18,
  vocab: [
    { id: "a1u1.ja", image: "/img/ja.png", hr: "ja", en: "I", pos: "pron", icon: "👤", exampleHr: "Ja sam Tom.", exampleEn: "I am Tom." },
    { id: "a1u1.ti", image: "/img/ti.png", hr: "ti", en: "you (one person, informal)", pos: "pron", icon: "🫵", exampleHr: "Ti si student.", exampleEn: "You are a student." },
    { id: "a1u1.on", image: "/img/on.png", hr: "on", en: "he", pos: "pron", icon: "👨", exampleHr: "On je đak.", exampleEn: "He is a pupil." },
    { id: "a1u1.ona", image: "/img/ona.png", hr: "ona", en: "she", pos: "pron", icon: "👩", exampleHr: "Ona je Ana.", exampleEn: "She is Ana." },
    { id: "a1u1.ono", image: "/img/ono.png", hr: "ono", en: "it / that one (neuter)", pos: "pron", icon: "⚪", exampleHr: "Ono je dobro.", exampleEn: "That one is good." },
    { id: "a1u1.mi", image: "/img/mi.png", hr: "mi", en: "we", pos: "pron", icon: "👥", exampleHr: "Mi smo prijatelji.", exampleEn: "We are friends." },
    { id: "a1u1.vi", image: "/img/vi.png", hr: "vi", en: "you (several people, or formal Vi)", pos: "pron", icon: "🧑‍🤝‍🧑", exampleHr: "Vi ste Ana i Tom.", exampleEn: "You are Ana and Tom." },
    { id: "a1u1.oni", image: "/img/oni.png", hr: "oni", en: "they", pos: "pron", icon: "👨‍👩‍👧", exampleHr: "Oni su studenti.", exampleEn: "They are students." },
