...
export const a1u1l1: Lesson = {
  ...
  estMinutes: 16,
  vocab: [
    { id: "a1u1.da", image: "/img/da.png", hr: "da", en: "yes", pos: "interj", icon: "👍", exampleHr: "Da, dobro je.", exampleEn: "Yes, it's good." },
    { id: "a1u1.ne", image: "/img/ne.png", hr: "ne", en: "no", pos: "interj", icon: "👎", exampleHr: "Kava? — Ne, voda!", exampleEn: "Coffee? — No, water!" },
    { id: "a1u1.i", image: "/img/i.png", hr: "i", en: "and", pos: "conj", exampleHr: "Kava i voda.", exampleEn: "Coffee and water." },
    { id: "a1u1.dobro", image: "/img/dobro.png", hr: "dobro", en: "good / well", pos: "adv", icon: "✨", exampleHr: "Dobro jutro!", exampleEn: "Good morning!" },
    { id: "a1u1.jutro", image: "/img/jutro.png", hr: "jutro", en: "morning", pos: "noun", gender: "n", icon: "🌅", exampleHr: "Dobro jutro!", exampleEn: "Good morning!" },
    { id: "a1u1.dan", image: "/img/dan.png", hr: "dan", en: "day", pos: "noun", gender: "m", icon: "🌤️", exampleHr: "Dobar dan!", exampleEn: "Good day! (hello)" },
    { id: "a1u1.vecer", image: "/img/vecer.png", hr: "večer", en: "evening", pos: "noun", gender: "f", icon: "🌆", exampleHr: "Dobra večer!", exampleEn: "Good evening!" },
    { id: "a1u1.noc", image: "/img/noc.png", hr: "noć", en: "night", pos: "noun", gender: "f", icon: "🌙", exampleHr: "Dan i noć.", exampleEn: "Day and night." },
    { id: "a1u1.kava", image: "/img/kava.png", hr: "kava", en: "coffee", pos: "noun", gender: "f", icon: "☕", exampleHr: "Kava i voda.", exampleEn: "Coffee and water." },
    { id: "a1u1.voda", image: "/img/voda.png", hr: "voda", en: "water", pos: "noun", gender: "f", icon: "💧", exampleHr: "Voda i kava.", exampleEn: "Water and coffee." },
  ],
  slides: [
    {
      id: "s01",
