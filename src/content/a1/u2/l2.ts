...
export const a1u2l2: Lesson = {
  ...
  estMinutes: 18,
  vocab: [
    { id: "a1u2.hrvat", image: "/img/hrvat.png", hr: "Hrvat", en: "Croat (man)", pos: "noun", gender: "m", icon: "🇭🇷", exampleHr: "Marko je Hrvat.", exampleEn: "Marko is a Croat." },
    { id: "a1u2.hrvatica", image: "/img/hrvatica.png", hr: "Hrvatica", en: "Croat (woman)", pos: "noun", gender: "f", icon: "🇭🇷", exampleHr: "Ana je Hrvatica.", exampleEn: "Ana is a Croat." },
    { id: "a1u2.kanadanin", image: "/img/kanadanin.png", hr: "Kanađanin", en: "Canadian (man)", pos: "noun", gender: "m", icon: "🇨🇦", exampleHr: "Tom je Kanađanin.", exampleEn: "Tom is a Canadian." },
    { id: "a1u2.kanadanka", image: "/img/kanadanka.png", hr: "Kanađanka", en: "Canadian (woman)", pos: "noun", gender: "f", icon: "🇨🇦", exampleHr: "Ona je Kanađanka.", exampleEn: "She is a Canadian." },
    { id: "a1u2.nijemac", image: "/img/nijemac.png", hr: "Nijemac", en: "German (man)", pos: "noun", gender: "m", icon: "🇩🇪", exampleHr: "On je Nijemac.", exampleEn: "He is a German." },
    { id: "a1u2.njemica", image: "/img/njemica.png", hr: "Njemica", en: "German (woman)", pos: "noun", gender: "f", icon: "🇩🇪", exampleHr: "Ona je Njemica.", exampleEn: "She is a German." },
    { id: "a1u2.englez", image: "/img/englez.png", hr: "Englez", en: "Englishman", pos: "noun", gender: "m", icon: "🇬🇧", exampleHr: "On je Englez.", exampleEn: "He is an Englishman." },
    { id: "a1u2.engleskinja", image: "/img/engleskinja.png", hr: "Engleskinja", en: "Englishwoman", pos: "noun", gender: "f", icon: "🇬🇧", exampleHr: "Ona je Engleskinja.", exampleEn: "She is an Englishwoman." },
    { id: "a1u2.amerikanac", image: "/img/amerikanac.png", hr: "Amerikanac", en: "American (man)", pos: "noun", gender: "m", icon: "🇺🇸", exampleHr: "On je Amerikanac.", exampleEn: "He is an American." },
    { id: "a1u2.amerikanka", image: "/img/amerikanka.png", hr: "Amerikanka", en: "American (woman)", pos: "noun", gender: "f", icon: "🇺🇸", exampleHr: "Ona je Amerikanka.", exampleEn: "She is an American." },
    { id: "a1u2.odakle", image: "/img/odakle.png", hr: "odakle", en: "from where", pos: "adv", icon: "❓", exampleHr: "Odakle si? — Iz Kanade.", exampleEn: "Where are you from? — From Canada.", tags: ["question-word"] },
