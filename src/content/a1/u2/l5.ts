...
export const a1u2l5: Lesson = {
  ...
  estMinutes: 20,
  vocab: [
    { id: "a1u2.hrvatski", image: "/img/hrvatski.png", hr: "hrvatski", en: "Croatian (language)", pos: "noun", gender: "m", icon: "🇭🇷", exampleHr: "Govorim malo hrvatski.", exampleEn: "I speak a little Croatian." },
    { id: "a1u2.engleski", image: "/img/engleski.png", hr: "engleski", en: "English (language)", pos: "noun", gender: "m", icon: "🇬🇧", exampleHr: "Govorim engleski.", exampleEn: "I speak English." },
    { id: "a1u2.njemacki", image: "/img/njemacki.png", hr: "njemački", en: "German (language)", pos: "noun", gender: "m", icon: "🇩🇪", exampleHr: "Govoriš li njemački?", exampleEn: "Do you speak German?" },
    { id: "a1u2.francuski", image: "/img/francuski.png", hr: "francuski", en: "French (language)", pos: "noun", gender: "m", icon: "🇫🇷", exampleHr: "Ne govorim francuski.", exampleEn: "I don't speak French." },
    { id: "a1u2.govoriti", image: "/img/govoriti.png", hr: "govoriti", en: "to speak (govorim)", pos: "verb", icon: "💬", exampleHr: "Govorim hrvatski i engleski.", exampleEn: "I speak Croatian and English." },
    { id: "a1u2.razumijem", image: "/img/razumijem.png", hr: "razumijem", en: "I understand (chunk: ne razumijem = I don't understand)", pos: "verb", icon: "💡", exampleHr: "Ne razumijem. Molim?", exampleEn: "I don't understand. Pardon?", tags: ["chunk"] },
    { id: "a1u2.malo", image: "/img/malo.png", hr: "malo", en: "a little", pos: "adv", icon: "🤏", exampleHr: "Govorim malo hrvatski.", exampleEn: "I speak a little Croatian." },
    { id: "a1u2.jako", image: "/img/jako.png", hr: "jako", en: "very", pos: "adv", icon: "💪", exampleHr: "Govoriš jako dobro!", exampleEn: "You speak very well!" },
