...
export const a1u7l4: Lesson = {
  ...
  vocab: [
    { id: "a1u7.dvadeset", hr: "dvadeset", en: "twenty (20)", pos: "num", icon: "🔢", exampleHr: "Dvadeset eura.", exampleEn: "Twenty euros." },
    { id: "a1u7.trideset", hr: "trideset", en: "thirty (30)", pos: "num", icon: "🔢", exampleHr: "Trideset eura.", exampleEn: "Thirty euros." },
    { id: "a1u7.cetrdeset", hr: "četrdeset", en: "forty (40)", pos: "num", icon: "🔢", exampleHr: "Četrdeset centi.", exampleEn: "Forty cents." },
    { id: "a1u7.pedeset", hr: "pedeset", en: "fifty (50)", pos: "num", icon: "🔢", exampleHr: "Pedeset centi.", exampleEn: "Fifty cents." },
    { id: "a1u7.sezdeset", hr: "šezdeset", en: "sixty (60)", pos: "num", icon: "🔢", exampleHr: "Šezdeset eura.", exampleEn: "Sixty euros." },
    { id: "a1u7.sedamdeset", hr: "sedamdeset", en: "seventy (70)", pos: "num", icon: "🔢", exampleHr: "Sedamdeset eura.", exampleEn: "Seventy euros." },
    { id: "a1u7.osamdeset", hr: "osamdeset", en: "eighty (80)", pos: "num", icon: "🔢", exampleHr: "Osamdeset eura.", exampleEn: "Eighty euros." },
    { id: "a1u7.devedeset", hr: "devedeset", en: "ninety (90)", pos: "num", icon: "🔢", exampleHr: "Devedeset devet eura.", exampleEn: "Ninety-nine euros." },
    { id: "a1u7.sto", hr: "sto", en: "one hundred (100)", pos: "num", icon: "💯", exampleHr: "Sto eura.", exampleEn: "One hundred euros." },
    { id: "a1u7.tisuca", hr: "tisuća", en: "one thousand (1000)", pos: "num", icon: "🔢", exampleHr: "Tisuća eura.", exampleEn: "One thousand euros." },
    { id: "a1u7.crven", hr: "crven", en: "red (crvena f, crveno n)", pos: "adj", icon: "🔴", exampleHr: "Crveno vino.", exampleEn: "Red wine." },
    { id: "a1u7.plav", hr: "plav", en: "blue (plava f, plavo n)", pos: "adj", icon: "🔵", exampleHr: "Plavo more.", exampleEn: "The blue sea." },
    { id: "a1u7.zelen", hr: "zelen", en: "green (zelena f, zeleno n)", pos: "adj", icon: "🟢", exampleHr: "Zelena jabuka.", exampleEn: "A green apple." },
    { id: "a1u7.zut", hr: "žut", en: "yellow (žuta f, žuto n)", pos: "adj", icon: "🟡", exampleHr: "Sir je žut.", exampleEn: "The cheese is yellow." },
    { id: "a1u7.crn", hr: "crn", en: "black (crna f, crno n)", pos: "adj", icon: "⚫", exampleHr: "Crna kava.", exampleEn: "Black coffee." },
    { id: "a1u7.bijel", hr: "bijel", en: "white (bijela f, bijelo n)", pos: "adj", icon: "⚪", exampleHr: "Bijelo vino.", exampleEn: "White wine." },
  ],
  slides: [
    {
      id: "s01",
