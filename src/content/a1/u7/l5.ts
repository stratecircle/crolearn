...
export const a1u7l5: Lesson = {
  ...
  estMinutes: 19,
  vocab: [
    { id: "a1u7.majica", image: "/img/majica.png", hr: "majica", en: "t-shirt", pos: "noun", gender: "f", icon: "👕", exampleHr: "Tražim majicu.", exampleEn: "I'm looking for a t-shirt." },
    { id: "a1u7.hlace", image: "/img/hlace.png", hr: "hlače", en: "trousers (plural-only)", pos: "noun", gender: "f", icon: "👖", exampleHr: "Plave hlače koštaju trideset eura.", exampleEn: "The blue trousers cost thirty euros." },
    { id: "a1u7.cipele", image: "/img/cipele.png", hr: "cipele", en: "shoes (plural-only)", pos: "noun", gender: "f", icon: "👟", exampleHr: "Nosim crne cipele.", exampleEn: "I'm wearing black shoes." },
    { id: "a1u7.jakna", image: "/img/jakna.png", hr: "jakna", en: "jacket", pos: "noun", gender: "f", icon: "🧥", exampleHr: "Tražim crnu jaknu.", exampleEn: "I'm looking for a black jacket." },
    { id: "a1u7.haljina", image: "/img/haljina.png", hr: "haljina", en: "dress", pos: "noun", gender: "f", icon: "👗", exampleHr: "Zelena haljina je lijepa.", exampleEn: "The green dress is nice." },
    { id: "a1u7.kosulja", image: "/img/kosulja.png", hr: "košulja", en: "shirt", pos: "noun", gender: "f", icon: "👔", exampleHr: "Bijela košulja.", exampleEn: "A white shirt." },
    { id: "a1u7.velicina", image: "/img/velicina.png", hr: "veličina", en: "size", pos: "noun", gender: "f", icon: "📏", exampleHr: "Moja veličina je M.", exampleEn: "My size is M." },
    { id: "a1u7.nositi", image: "/img/nositi.png", hr: "nositi", en: "to wear (nosim)", pos: "verb", icon: "🧍", exampleHr: "Nosim plavu majicu.", exampleEn: "I'm wearing a blue t-shirt." },
    { id: "a1u7.probati", image: "/img/probati.png", hr: "probati", en: "to try on (probam)", pos: "verb", icon: "🔄", exampleHr: "Želim probati jaknu.", exampleEn: "I want to try on the jacket." },
    { id: "a1u7.kupovati", image: "/img/kupovati.png", hr: "kupovati", en: "to buy (kupujem)", pos: "verb", icon: "🛍️", exampleHr: "Kupujem plavu majicu.", exampleEn: "I'm buying a blue t-shirt." },
    { id: "a1u7.traziti", image: "/img/traziti.png", hr: "tražiti", en: "to look for (tražim)", pos: "verb", icon: "🔎", exampleHr: "Tražim majicu.", exampleEn: "I'm looking for a t-shirt." },
  ],
  slides: [
    {
      id: "s01",
