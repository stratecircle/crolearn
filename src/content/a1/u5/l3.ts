...
export const a1u5l3: Lesson = {
  ...
  estMinutes: 19,
  vocab: [
    { id: "a1u5.ici", image: "/img/ici.png", hr: "ići", en: "to go (idem, ideš…)", pos: "verb", icon: "🚶", exampleHr: "Idem na kavu.", exampleEn: "I'm going for a coffee." },
    { id: "a1u5.posao", image: "/img/posao.png", hr: "posao", en: "job / work (na posao; LOC na poslu)", pos: "noun", gender: "m", icon: "💼", exampleHr: "Marko ide na posao.", exampleEn: "Marko is going to work." },
    { id: "a1u5.fakultet", image: "/img/fakultet.png", hr: "fakultet", en: "university / faculty", pos: "noun", gender: "m", icon: "🎓", exampleHr: "Ana je na fakultetu.", exampleEn: "Ana is at university." },
    { id: "a1u5.kazaliste", image: "/img/kazaliste.png", hr: "kazalište", en: "theatre", pos: "noun", gender: "n", icon: "🎭", exampleHr: "Idemo u kazalište.", exampleEn: "We are going to the theatre." },
    { id: "a1u5.koncert", image: "/img/koncert.png", hr: "koncert", en: "concert", pos: "noun", gender: "m", icon: "🎵", exampleHr: "Idem na koncert.", exampleEn: "I'm going to a concert." },
    { id: "a1u5.zracna-luka", image: "/img/zracnaluka.png", hr: "zračna luka", en: "airport", pos: "noun", gender: "f", icon: "✈️", exampleHr: "Zračna luka je daleko.", exampleEn: "The airport is far." },
    { id: "a1u5.tramvaj", image: "/img/tramvaj.png", hr: "tramvaj", en: "tram", pos: "noun", gender: "m", icon: "🚊", exampleHr: "Čekam tramvaj.", exampleEn: "I'm waiting for the tram." },
    { id: "a1u5.autobus", image: "/img/autobus.png", hr: "autobus", en: "bus", pos: "noun", gender: "m", icon: "🚌", exampleHr: "Autobus je na stanici.", exampleEn: "The bus is at the stop." },
    { id: "a1u5.stanica", image: "/img/stanica.png", hr: "stanica", en: "stop", pos: "noun", gender: "f", icon: "🚏", exampleHr: "Čekam na stanici.", exampleEn: "I'm waiting at the stop." },
  ],
  slides: [
    {
      id: "s01",
