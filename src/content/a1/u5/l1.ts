...
export const a1u5l1: Lesson = {
  ...
  estMinutes: 18,
  vocab: [
    { id: "a1u5.trg", image: "/img/trg.png", hr: "trg", en: "square", pos: "noun", gender: "m", icon: "🏙️", exampleHr: "Muzej je na trgu.", exampleEn: "The museum is on the square." },
    { id: "a1u5.ulica", image: "/img/ulica.png", hr: "ulica", en: "street", pos: "noun", gender: "f", icon: "🛣️", exampleHr: "Pošta je u ulici.", exampleEn: "The post office is on the street." },
    { id: "a1u5.muzej", image: "/img/muzej.png", hr: "muzej", en: "museum", pos: "noun", gender: "m", icon: "🏛️", exampleHr: "Tom je u muzeju.", exampleEn: "Tom is in the museum." },
    { id: "a1u5.crkva", image: "/img/crkva.png", hr: "crkva", en: "church", pos: "noun", gender: "f", icon: "⛪", exampleHr: "Crkva je na trgu.", exampleEn: "The church is on the square." },
    { id: "a1u5.posta", image: "/img/posta.png", hr: "pošta", en: "post office", pos: "noun", gender: "f", icon: "📮", exampleHr: "Pošta je u ulici.", exampleEn: "The post office is on the street." },
    { id: "a1u5.banka", image: "/img/banka.png", hr: "banka", en: "bank", pos: "noun", gender: "f", icon: "🏦", exampleHr: "Tata je u banci.", exampleEn: "Dad is at the bank." },
    { id: "a1u5.park", image: "/img/park.png", hr: "park", en: "park", pos: "noun", gender: "m", icon: "🌳", exampleHr: "Djeca su u parku.", exampleEn: "The children are in the park." },
    { id: "a1u5.centar", image: "/img/centar.png", hr: "centar", en: "centre / downtown", pos: "noun", gender: "m", icon: "📍", exampleHr: "Muzej je u centru.", exampleEn: "The museum is in the centre." },
    { id: "a1u5.zivjeti", image: "/img/zivjeti.png", hr: "živjeti", en: "to live (živim, živiš…)", pos: "verb", icon: "🏡", exampleHr: "Živim u Zagrebu.", exampleEn: "I live in Zagreb." },
  ],
  slides: [
    {
      id: "s01",
