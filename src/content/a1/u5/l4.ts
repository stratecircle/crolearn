...
export const a1u5l4: Lesson = {
  ...
  vocab: [
    { id: "a1u5.prvi", image: "/img/prvi.png", hr: "prvi", en: "first (prva, prvo)", pos: "num", icon: "1️⃣", exampleHr: "Živim na prvom katu.", exampleEn: "I live on the first floor." },
    { id: "a1u5.drugi", image: "/img/drugi.png", hr: "drugi", en: "second (druga, drugo)", pos: "num", icon: "2️⃣", exampleHr: "Stan je na drugom katu.", exampleEn: "The apartment is on the second floor." },
    { id: "a1u5.treci", image: "/img/treci.png", hr: "treći", en: "third (treća, treće — the odd one)", pos: "num", icon: "3️⃣", exampleHr: "Živim na trećem katu.", exampleEn: "I live on the third floor." },
    { id: "a1u5.cetvrti", image: "/img/cetvrti.png", hr: "četvrti", en: "fourth (četvrta, četvrto)", pos: "num", icon: "4️⃣", exampleHr: "Ana je na četvrtom katu.", exampleEn: "Ana is on the fourth floor." },
    { id: "a1u5.peti", image: "/img/peti.png", hr: "peti", en: "fifth (peta, peto)", pos: "num", icon: "5️⃣", exampleHr: "Stan je na petom katu.", exampleEn: "The apartment is on the fifth floor." },
    { id: "a1u5.sesti", image: "/img/sesti.png", hr: "šesti", en: "sixth (šesta, šesto)", pos: "num", icon: "6️⃣", exampleHr: "Muzej je na šestom katu.", exampleEn: "The museum is on the sixth floor." },
    { id: "a1u5.sedmi", image: "/img/sedmi.png", hr: "sedmi", en: "seventh (sedma, sedmo)", pos: "num", icon: "7️⃣", exampleHr: "Stan broj sedam je na sedmom katu.", exampleEn: "Apartment number seven is on the seventh floor." },
    { id: "a1u5.osmi", image: "/img/osmi.png", hr: "osmi", en: "eighth (osma, osmo)", pos: "num", icon: "8️⃣", exampleHr: "Živim na osmom katu.", exampleEn: "I live on the eighth floor." },
    { id: "a1u5.deveti", image: "/img/deveti.png", hr: "deveti", en: "ninth (deveta, deveto)", pos: "num", icon: "9️⃣", exampleHr: "Stan je na devetom katu.", exampleEn: "The apartment is on the ninth floor." },
    { id: "a1u5.deseti", image: "/img/deseti.png", hr: "deseti", en: "tenth (deseta, deseto)", pos: "num", icon: "🔟", exampleHr: "Živim na desetom katu.", exampleEn: "I live on the tenth floor." },
    { id: "a1u5.kat", image: "/img/kat.png", hr: "kat", en: "floor / storey", pos: "noun", gender: "m", icon: "🏢", exampleHr: "Živim na trećem katu.", exampleEn: "I live on the third floor." },
    { id: "a1u5.prizemlje", image: "/img/prizemlje.png", hr: "prizemlje", en: "ground floor", pos: "noun", gender: "n", icon: "🚪", exampleHr: "Banka je u prizemlju.", exampleEn: "The bank is on the ground floor." },
    { id: "a1u5.zgrada", image: "/img/zgrada.png", hr: "zgrada", en: "building", pos: "noun", gender: "f", icon: "🏬", exampleHr: "Zgrada je velika.", exampleEn: "The building is big." },
    { id: "a1u5.stan", image: "/img/stan.png", hr: "stan", en: "apartment / flat", pos: "noun", gender: "m", icon: "🏠", exampleHr: "Stan je na drugom katu.", exampleEn: "The apartment is on the second floor." },
    { id: "a1u5.adresa", image: "/img/adresa.png", hr: "adresa", en: "address", pos: "noun", gender: "f", icon: "📫", exampleHr: "Moja adresa je Ilica petnaest.", exampleEn: "My address is Ilica fifteen." },
  ],
  slides: [
    {
      id: "s01",
