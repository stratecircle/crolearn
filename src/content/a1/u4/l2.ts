...
export const a1u4l2: Lesson = {
  ...
  vocab: [
    ...
    { id: "a1u4.rucati", image: "/img/rucati.png", hr: "ručati", en: "to have lunch (ručam)", pos: "verb", icon: "🍽️", exampleHr: "Ana ruča.", exampleEn: "Ana is having lunch." },
    { id: "a1u4.vecerati", image: "/img/vecerati.png", hr: "večerati", en: "to have dinner (večeram)", pos: "verb", icon: "🌆", exampleHr: "Tom večera ribu.", exampleEn: "Tom is having fish for dinner." },
