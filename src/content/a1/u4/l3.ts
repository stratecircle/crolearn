...
export const a1u4l3: Lesson = {
  ...
  estMinutes: 18,
  vocab: [
    { id: "a1u4.piti", image: "/img/piti.png", hr: "piti", en: "to drink (pijem)", pos: "verb", icon: "🥤", exampleHr: "Pijem kavu.", exampleEn: "I drink coffee." },
    { id: "a1u4.jesti", image: "/img/jesti.png", hr: "jesti", en: "to eat (jedem — irregular)", pos: "verb", icon: "🍴", exampleHr: "Jedem ribu.", exampleEn: "I eat fish." },
    { id: "a1u4.voljeti", image: "/img/voljeti.png", hr: "voljeti", en: "to love / like (volim)", pos: "verb", icon: "❤️", exampleHr: "Volim voće.", exampleEn: "I love fruit." },
    { id: "a1u4.zeljeti", image: "/img/zeljeti.png", hr: "željeti", en: "to want / wish (želim)", pos: "verb", icon: "🙏", exampleHr: "Želim juhu.", exampleEn: "I want soup." },
