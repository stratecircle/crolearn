...
export const a1u8l4: Lesson = {
  ...
  vocab: [
    ...
    { id: "a1u8.vjetar", hr: "vjetar", en: "wind", pos: "noun", gender: "m", icon: "💨", exampleHr: "Danas ima vjetra.", exampleEn: "It's windy today." },
    { id: "a1u8.oblak", hr: "oblak", en: "cloud", pos: "noun", gender: "m", icon: "☁️", exampleHr: "Ima oblaka.", exampleEn: "There are clouds." },
    { id: "a1u8.suncano", hr: "sunčano", en: "sunny", pos: "adv", icon: "🌞", exampleHr: "Sunčano je.", exampleEn: "It's sunny." },
    { id: "a1u8.oblacno", hr: "oblačno", en: "cloudy", pos: "adv", icon: "🌥️", exampleHr: "Oblačno je.", exampleEn: "It's cloudy." },
    { id: "a1u8.toplo", hr: "toplo", en: "warm", pos: "adv", icon: "🌡️", exampleHr: "Toplo je.", exampleEn: "It's warm." },
    { id: "a1u8.hladno", hr: "hladno", en: "cold", pos: "adv", icon: "🥶", exampleHr: "Hladno je.", exampleEn: "It's cold." },
    { id: "a1u8.vruce", hr: "vruće", en: "hot", pos: "adv", icon: "🔥", exampleHr: "Vruće je.", exampleEn: "It's hot." },
    { id: "a1u8.padati", hr: "padati", en: "to fall (pada kiša = it rains)", pos: "verb", icon: "⬇️", exampleHr: "Padala je kiša.", exampleEn: "It was raining." },
  ],
  slides: [
    {
      id: "s01",
