...
export const a2u11l1: Lesson = {
  ...
  estMinutes: 18,
  vocab: [
    { id: "a2u11.glava", image: "/img/glava.png", hr: "glava", en: "head", pos: "noun", gender: "f", icon: "🙂", exampleHr: "Boli me glava.", exampleEn: "My head hurts." },
    { id: "a2u11.ruka", image: "/img/ruka.png", hr: "ruka", en: "arm / hand", pos: "noun", gender: "f", icon: "💪", exampleHr: "Boli me ruka.", exampleEn: "My arm hurts." },
    { id: "a2u11.noga", image: "/img/noga.png", hr: "noga", en: "leg / foot", pos: "noun", gender: "f", icon: "🦵", exampleHr: "Boli me noga.", exampleEn: "My leg hurts." },
    { id: "a2u11.oko", image: "/img/oko.png", hr: "oko", en: "eye (plural: oči!)", pos: "noun", gender: "n", icon: "👁️", exampleHr: "Bole me oči.", exampleEn: "My eyes hurt." },
    { id: "a2u11.uho", image: "/img/uho.png", hr: "uho", en: "ear (plural: uši!)", pos: "noun", gender: "n", icon: "👂", exampleHr: "Boli me uho.", exampleEn: "My ear hurts." },
    { id: "a2u11.zub", image: "/img/zub.png", hr: "zub", en: "tooth", pos: "noun", gender: "m", icon: "🦷", exampleHr: "Toma boli zub.", exampleEn: "Tom's tooth hurts." },
    { id: "a2u11.grlo", image: "/img/grlo.png", hr: "grlo", en: "throat", pos: "noun", gender: "n", icon: "🗣️", exampleHr: "Boli me grlo.", exampleEn: "My throat hurts." },
    { id: "a2u11.trbuh", image: "/img/trbuh.png", hr: "trbuh", en: "stomach / belly", pos: "noun", gender: "m", icon: "🫃", exampleHr: "Boli me trbuh.", exampleEn: "My stomach hurts." },
    { id: "a2u11.leda", image: "/img/leda.png", hr: "leđa", en: "back (a plural-only noun!)", pos: "noun", gender: "n", icon: "🧍", exampleHr: "Bole me leđa.", exampleEn: "My back hurts." },
    { id: "a2u11.srce", image: "/img/srce.png", hr: "srce", en: "heart", pos: "noun", gender: "n", icon: "❤️", exampleHr: "Srce je zdravo.", exampleEn: "The heart is healthy." },
    { id: "a2u11.boljeti", image: "/img/boljeti.png", hr: "boljeti", en: "to hurt (boli / bole)", pos: "verb", icon: "🤕", exampleHr: "Što te boli?", exampleEn: "What hurts you?" },
  ],
  slides: [
    {
      id: "s01",
