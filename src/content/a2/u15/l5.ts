...
export const a2u15l5: Lesson = {
  ...
  estMinutes: 20,
  vocab: [
    { id: "a2u15.veza", image: "/img/veza.png", hr: "veza", en: "connection (Ostanimo u vezi! = let's stay in touch)", pos: "noun", gender: "f", icon: "🔗", exampleHr: "Ostanimo u vezi!", exampleEn: "Let's stay in touch!" },
    { id: "a2u15.objava", image: "/img/objava.png", hr: "objava", en: "post (on social media)", pos: "noun", gender: "f", icon: "📣", exampleHr: "Sviđa mi se objava.", exampleEn: "I like the post." },
    { id: "a2u15.pratiti", image: "/img/pratiti.png", hr: "pratiti", en: "to follow (pratim)", pos: "verb", icon: "👣", exampleHr: "Tom prati Anu na internetu.", exampleEn: "Tom follows Ana online." },
    { id: "a2u15.dopisivatise", image: "/img/dopisivatise.png", hr: "dopisivati se", en: "to text back and forth (dopisujem se)", pos: "verb", icon: "💬", exampleHr: "Dopisujemo se svaki dan.", exampleEn: "We text each other every day." },
    { id: "a2u15.videopoziv", image: "/img/videopoziv.png", hr: "video-poziv", en: "video call", pos: "noun", gender: "m", icon: "🎥", exampleHr: "Imamo video-poziv u osam.", exampleEn: "We have a video call at eight." },
    { id: "a2u15.dijeliti", image: "/img/dijeliti.png", hr: "dijeliti", en: "to share (dijelim)", pos: "verb", icon: "🤝", exampleHr: "Dijelim slike s Anom.", exampleEn: "I share pictures with Ana." },
    { id: "a2u15.internet", image: "/img/internet.png", hr: "internet", en: "internet", pos: "noun", gender: "m", icon: "🌐", exampleHr: "Internet ne radi!", exampleEn: "The internet isn't working!" },
    { id: "a2u15.mreza", image: "/img/mreza.png", hr: "mreža", en: "network", pos: "noun", gender: "f", icon: "📶", exampleHr: "Mreža je spora.", exampleEn: "The network is slow." },
    { id: "a2u15.lozinka", image: "/img/lozinka.png", hr: "lozinka", en: "password", pos: "noun", gender: "f", icon: "🔑", exampleHr: "Moja lozinka je tajna.", exampleEn: "My password is a secret." },
    { id: "a2u15.stranica", image: "/img/stranica.png", hr: "stranica", en: "page / website", pos: "noun", gender: "f", icon: "🖥️", exampleHr: "Gledam stranicu.", exampleEn: "I'm looking at the page." },
    { id: "a2u15.aplikacija", image: "/img/aplikacija.png", hr: "aplikacija", en: "app", pos: "noun", gender: "f", icon: "📲", exampleHr: "Aplikacija je dobra.", exampleEn: "The app is good." },
    { id: "a2u15.objaviti", image: "/img/objaviti.png", hr: "objaviti", en: "to post / publish (objavim)", pos: "verb", icon: "🚀", exampleHr: "Ana je objavila sliku.", exampleEn: "Ana posted a picture." },
  ],
  slides: [
    {
      id: "s01",
