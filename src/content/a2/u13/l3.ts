...
export const a2u13l3: Lesson = {
  ...
  estMinutes: 19,
  vocab: [
    { id: "a2u13.proljece", hr: "proljeće", en: "spring", pos: "noun", gender: "n", icon: "🌸", exampleHr: "Proljeće je lijepo.", exampleEn: "Spring is beautiful." },
    { id: "a2u13.jesen", hr: "jesen", en: "autumn (f — an -i noun!)", pos: "noun", gender: "f", icon: "🍂", exampleHr: "U jesen pada kiša.", exampleEn: "In autumn it rains." },
    { id: "a2u13.zima", hr: "zima", en: "winter", pos: "noun", gender: "f", icon: "❄️", exampleHr: "Zima je hladna.", exampleEn: "Winter is cold." },
    { id: "a2u13.godisnjedoba", hr: "godišnje doba", en: "season (of the year)", pos: "phrase", gender: "n", icon: "🗓️", exampleHr: "U Hrvatskoj ima četiri godišnja doba.", exampleEn: "Croatia has four seasons." },
    { id: "a2u13.topao", hr: "topao", en: "warm (topla, toplo)", pos: "adj", icon: "🌡️", exampleHr: "Ljeto je toplo.", exampleEn: "Summer is warm." },
    { id: "a2u13.hladan", hr: "hladan", en: "cold (hladna, hladno)", pos: "adj", icon: "🥶", exampleHr: "Danas je hladan dan.", exampleEn: "Today is a cold day." },
    { id: "a2u13.vruc", hr: "vruć", en: "hot (vruća, vruće)", pos: "adj", icon: "🔥", exampleHr: "Ljeti je vruće.", exampleEn: "In summer it's hot." },
    { id: "a2u13.svjez", hr: "svjež", en: "fresh / cool (svježa, svježe)", pos: "adj", icon: "🍃", exampleHr: "Voda je svježa.", exampleEn: "The water is fresh." },
    { id: "a2u13.ljeti", hr: "ljeti", en: "in summer (fixed adverb)", pos: "adv", icon: "☀️", exampleHr: "Ljeti idemo na more.", exampleEn: "In summer we go to the seaside.", tags: ["chunk"] },
    { id: "a2u13.zimi", hr: "zimi", en: "in winter (fixed adverb)", pos: "adv", icon: "⛷️", exampleHr: "Zimi pada snijeg.", exampleEn: "In winter it snows.", tags: ["chunk"] },
  ],
  slides: [
    {
      id: "s01",
