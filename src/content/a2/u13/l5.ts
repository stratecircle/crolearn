...
export const a2u13l5: Lesson = {
  ...
  estMinutes: 20,
  vocab: [
    { id: "a2u13.drvo", hr: "drvo", en: "tree", pos: "noun", gender: "n", icon: "🌳", exampleHr: "Drvo u parku je staro.", exampleEn: "The tree in the park is old." },
    { id: "a2u13.cvijet", hr: "cvijet", en: "flower", pos: "noun", gender: "m", icon: "🌼", exampleHr: "Cvijet je lijep.", exampleEn: "The flower is beautiful." },
    { id: "a2u13.trava", hr: "trava", en: "grass", pos: "noun", gender: "f", icon: "🌿", exampleHr: "Trava je zelena.", exampleEn: "The grass is green." },
    { id: "a2u13.nebo", hr: "nebo", en: "sky", pos: "noun", gender: "n", icon: "☁️", exampleHr: "Nebo je plavo.", exampleEn: "The sky is blue." },
    { id: "a2u13.zrak", hr: "zrak", en: "air", pos: "noun", gender: "m", icon: "💨", exampleHr: "Zrak na planini je svjež.", exampleEn: "The air on the mountain is fresh." },
    { id: "a2u13.kamen", hr: "kamen", en: "stone", pos: "noun", gender: "m", icon: "🪨", exampleHr: "Kamen je velik i star.", exampleEn: "The stone is big and old." },
    { id: "a2u13.pogled", hr: "pogled", en: "view", pos: "noun", gender: "m", icon: "🌅", exampleHr: "Pogled na more je predivan.", exampleEn: "The view of the sea is wonderful." },
    { id: "a2u13.predivan", hr: "predivan", en: "wonderful, gorgeous (predivna, predivno)", pos: "adj", icon: "🤩", exampleHr: "Priroda je predivna.", exampleEn: "Nature is wonderful." },
    { id: "a2u13.mjesto", hr: "mjesto", en: "place", pos: "noun", gender: "n", icon: "📍", exampleHr: "Moje najljepše mjesto je more.", exampleEn: "My most beautiful place is the seaside." },
    { id: "a2u13.vise", hr: "više", en: "more (the comparative of puno!)", pos: "adv", icon: "📈", exampleHr: "U gradu ima više ljudi nego u selu.", exampleEn: "There are more people in the city than in the village." },
  ],
  slides: [
    {
      id: "s01",
