...
export const a2u14l4: Lesson = {
  ...
  vocab: [
    { id: "a2u14.sijecanj", hr: "siječanj", en: "January (GEN siječnja)", pos: "noun", gender: "m", icon: "🥶", exampleHr: "Siječanj je prvi mjesec.", exampleEn: "January is the first month." },
    { id: "a2u14.veljaca", hr: "veljača", en: "February (GEN veljače)", pos: "noun", gender: "f", icon: "❄️", exampleHr: "Veljača je najkraći mjesec.", exampleEn: "February is the shortest month." },
    { id: "a2u14.ozujak", hr: "ožujak", en: "March (GEN ožujka)", pos: "noun", gender: "m", icon: "🌱", exampleHr: "Proljeće je u ožujku.", exampleEn: "Spring is in March." },
    { id: "a2u14.travanj", hr: "travanj", en: "April (GEN travnja)", pos: "noun", gender: "m", icon: "🌷", exampleHr: "Uskrs je često u travnju.", exampleEn: "Easter is often in April." },
    { id: "a2u14.svibanj", hr: "svibanj", en: "May (GEN svibnja)", pos: "noun", gender: "m", icon: "🌼", exampleHr: "Svibanj je peti mjesec.", exampleEn: "May is the fifth month." },
    { id: "a2u14.lipanj", hr: "lipanj", en: "June (GEN lipnja)", pos: "noun", gender: "m", icon: "☀️", exampleHr: "U lipnju je toplo.", exampleEn: "It's warm in June." },
    { id: "a2u14.srpanj", hr: "srpanj", en: "July (GEN srpnja)", pos: "noun", gender: "m", icon: "🏖️", exampleHr: "U srpnju idemo na more.", exampleEn: "In July we go to the seaside." },
    { id: "a2u14.kolovoz", hr: "kolovoz", en: "August (GEN kolovoza)", pos: "noun", gender: "m", icon: "🔥", exampleHr: "Kolovoz je vruć.", exampleEn: "August is hot." },
    { id: "a2u14.rujan", hr: "rujan", en: "September (GEN rujna)", pos: "noun", gender: "m", icon: "🍇", exampleHr: "U rujnu je svježe.", exampleEn: "It's cool in September." },
    { id: "a2u14.listopad", hr: "listopad", en: "October (GEN listopada)", pos: "noun", gender: "m", icon: "🍂", exampleHr: "U listopadu pada kiša.", exampleEn: "In October it rains." },
    { id: "a2u14.studeni", hr: "studeni", en: "November (GEN studenog)", pos: "noun", gender: "m", icon: "🌫️", exampleHr: "Studeni je hladan.", exampleEn: "November is cold." },
    { id: "a2u14.prosinac", hr: "prosinac", en: "December (GEN prosinca)", pos: "noun", gender: "m", icon: "🎄", exampleHr: "Božić je u prosincu.", exampleEn: "Christmas is in December." },
    { id: "a2u14.mjesec", hr: "mjesec", en: "month (also: moon)", pos: "noun", gender: "m", icon: "🗓️", exampleHr: "Godina ima dvanaest mjeseci.", exampleEn: "A year has twelve months." },
    { id: "a2u14.bozic", hr: "Božić", en: "Christmas", pos: "noun", gender: "m", icon: "🎄", exampleHr: "Božić je dvadeset petog prosinca.", exampleEn: "Christmas is on December 25th." },
    { id: "a2u14.uskrs", hr: "Uskrs", en: "Easter", pos: "noun", gender: "m", icon: "🐣", exampleHr: "Uskrs je u proljeće.", exampleEn: "Easter is in spring." },
    { id: "a2u14.novagodina", hr: "Nova godina", en: "New Year", pos: "phrase", gender: "f", icon: "🎆", exampleHr: "Nova godina je prvog siječnja.", exampleEn: "New Year is on January 1st." },
    { id: "a2u14.blagdan", hr: "blagdan", en: "holiday", pos: "noun", gender: "m", icon: "📅", exampleHr: "Božić je veliki blagdan.", exampleEn: "Christmas is a big holiday." },
    { id: "a2u14.datum", hr: "datum", en: "date", pos: "noun", gender: "m", icon: "🔢", exampleHr: "Koji je datum danas?", exampleEn: "What's the date today?" },
    { id: "a2u14.svijeca", hr: "svijeća", en: "candle", pos: "noun", gender: "f", icon: "🕯️", exampleHr: "Na torti je pet svijeća.", exampleEn: "There are five candles on the cake." },
    { id: "a2u14.cestitka", hr: "čestitka", en: "greeting card", pos: "noun", gender: "f", icon: "💌", exampleHr: "Pišem čestitku baki.", exampleEn: "I'm writing grandma a card." },
  ],
  slides: [
    {
      id: "s01",
