...
export const a2u12l3: Lesson = {
  ...
  estMinutes: 18,
  vocab: [
    { id: "a2u12.radnik", hr: "radnik", en: "worker (m)", pos: "noun", gender: "m", icon: "👷", exampleHr: "Radnik radi u tvrtki.", exampleEn: "The worker works at a company." },
    { id: "a2u12.radnica", hr: "radnica", en: "worker (f)", pos: "noun", gender: "f", icon: "👷‍♀️", exampleHr: "Ana je dobra radnica.", exampleEn: "Ana is a good worker." },
    { id: "a2u12.prodavac", hr: "prodavač", en: "shop assistant (m)", pos: "noun", gender: "m", icon: "🛒", exampleHr: "Prodavač radi u trgovini.", exampleEn: "The shop assistant works in a shop." },
    { id: "a2u12.prodavacica", hr: "prodavačica", en: "shop assistant (f)", pos: "noun", gender: "f", icon: "🛍️", exampleHr: "Prodavačica je ljubazna.", exampleEn: "The shop assistant is kind." },
    { id: "a2u12.vozac", hr: "vozač", en: "driver (m)", pos: "noun", gender: "m", icon: "🚌", exampleHr: "Vozač vozi autobus.", exampleEn: "The driver drives the bus." },
    { id: "a2u12.vozacica", hr: "vozačica", en: "driver (f)", pos: "noun", gender: "f", icon: "🚕", exampleHr: "Vozačica radi noću.", exampleEn: "The driver works at night." },
    { id: "a2u12.programer", hr: "programer", en: "programmer (m)", pos: "noun", gender: "m", icon: "💻", exampleHr: "Programer radi računalom.", exampleEn: "A programmer works with a computer." },
    { id: "a2u12.programerica", hr: "programerica", en: "programmer (f)", pos: "noun", gender: "f", icon: "👩‍💻", exampleHr: "Programerica zarađuje dobro.", exampleEn: "The programmer earns well." },
    { id: "a2u12.zaradivati", hr: "zarađivati", en: "to earn (zarađujem)", pos: "verb", icon: "💰", exampleHr: "Zarađujem dobro.", exampleEn: "I earn well." },
    { id: "a2u12.placa", hr: "plaća", en: "salary / pay", pos: "noun", gender: "f", icon: "💶", exampleHr: "Plaća je dobra.", exampleEn: "The salary is good." },
  ],
  slides: [
    {
      id: "s01",
