...
export const a2u12l1: Lesson = {
  ...
  estMinutes: 18,
  vocab: [
    { id: "a2u12.ured", hr: "ured", en: "office", pos: "noun", gender: "m", icon: "🏢", exampleHr: "Radim u uredu.", exampleEn: "I work in an office." },
    { id: "a2u12.tvrtka", hr: "tvrtka", en: "company / firm", pos: "noun", gender: "f", icon: "🏛️", exampleHr: "Tvrtka je velika.", exampleEn: "The company is big." },
    { id: "a2u12.kolega", hr: "kolega", en: "colleague (m — but declines like -a!)", pos: "noun", gender: "m", icon: "👨‍💼", exampleHr: "Radim s kolegom.", exampleEn: "I work with a colleague." },
    { id: "a2u12.kolegica", hr: "kolegica", en: "colleague (f)", pos: "noun", gender: "f", icon: "👩‍💼", exampleHr: "Učim s kolegicom.", exampleEn: "I study with a colleague." },
    { id: "a2u12.sef", hr: "šef", en: "boss (m)", pos: "noun", gender: "m", icon: "🧑‍💼", exampleHr: "Imamo sastanak sa šefom.", exampleEn: "We have a meeting with the boss." },
    { id: "a2u12.sefica", hr: "šefica", en: "boss (f)", pos: "noun", gender: "f", icon: "👩‍💼", exampleHr: "Ana razgovara sa šeficom.", exampleEn: "Ana is talking with the boss." },
    { id: "a2u12.sastanak", hr: "sastanak", en: "meeting", pos: "noun", gender: "m", icon: "📅", exampleHr: "Sastanak je u devet sati.", exampleEn: "The meeting is at nine." },
    { id: "a2u12.tim", hr: "tim", en: "team", pos: "noun", gender: "m", icon: "🧑‍🤝‍🧑", exampleHr: "Naš tim radi zajedno.", exampleEn: "Our team works together." },
    { id: "a2u12.zajedno", hr: "zajedno", en: "together", pos: "adv", icon: "🤝", exampleHr: "Radimo zajedno.", exampleEn: "We work together." },
  ],
  slides: [
    {
      id: "s01",
