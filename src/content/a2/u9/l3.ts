...
export const a2u9l3: Lesson = {
  ...
  estMinutes: 18,
  vocab: [
    { id: "a2u9.granica", image: "/img/granica.png", hr: "granica", en: "border", pos: "noun", gender: "f", icon: "🛂", exampleHr: "Na granici je carina.", exampleEn: "At the border there is customs." },
    { id: "a2u9.putovnica", image: "/img/putovnica.png", hr: "putovnica", en: "passport", pos: "noun", gender: "f", icon: "🛂", exampleHr: "Ne putujem bez putovnice.", exampleEn: "I don't travel without a passport." },
    { id: "a2u9.prtljaga", image: "/img/prtljaga.png", hr: "prtljaga", en: "luggage", pos: "noun", gender: "f", icon: "🧳", exampleHr: "Moja prtljaga je velika.", exampleEn: "My luggage is big." },
    { id: "a2u9.kovceg", image: "/img/kovceg.png", hr: "kovčeg", en: "suitcase", pos: "noun", gender: "m", icon: "💼", exampleHr: "Kovčeg je velik.", exampleEn: "The suitcase is big." },
    { id: "a2u9.ruksak", image: "/img/ruksak.png", hr: "ruksak", en: "backpack", pos: "noun", gender: "m", icon: "🎒", exampleHr: "Putovnica je u ruksaku.", exampleEn: "The passport is in the backpack." },
    { id: "a2u9.carina", image: "/img/carina.png", hr: "carina", en: "customs", pos: "noun", gender: "f", icon: "🛃", exampleHr: "Carina je na granici.", exampleEn: "Customs is at the border." },
    { id: "a2u9.obala", image: "/img/obala.png", hr: "obala", en: "coast", pos: "noun", gender: "f", icon: "🌅", exampleHr: "Split je na obali.", exampleEn: "Split is on the coast." },
    { id: "a2u9.kod", image: "/img/kod.png", hr: "kod", en: "at somebody's place (+ genitive)", pos: "prep", icon: "🏡", exampleHr: "Spavat ćemo kod bake Marije.", exampleEn: "We'll sleep at grandma Marija's place." },
    { id: "a2u9.bez", image: "/img/bez.png", hr: "bez", en: "without (+ genitive)", pos: "prep", icon: "🚫", exampleHr: "Ne putujem bez putovnice.", exampleEn: "I don't travel without a passport." },
  ],
  slides: [
    {
      id: "s01",
