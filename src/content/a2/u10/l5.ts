...
export const a2u10l5: Lesson = {
  ...
  estMinutes: 20,
  vocab: [
    { id: "a2u10.kupaonica", hr: "kupaonica", en: "bathroom", pos: "noun", gender: "f", icon: "🛁", exampleHr: "Perem rublje u kupaonici.", exampleEn: "I wash the laundry in the bathroom." },
    { id: "a2u10.spavaca-soba", hr: "spavaća soba", en: "bedroom", pos: "phrase", icon: "🛏️", exampleHr: "Sviđa mi se spavaća soba.", exampleEn: "I like the bedroom." },
    { id: "a2u10.dnevni-boravak", hr: "dnevni boravak", en: "living room", pos: "phrase", icon: "🛋️", exampleHr: "U dnevnom boravku je velik stol.", exampleEn: "In the living room there's a big table." },
    { id: "a2u10.hodnik", hr: "hodnik", en: "hallway", pos: "noun", gender: "m", icon: "🚪", exampleHr: "U hodniku je velik ormar.", exampleEn: "In the hallway there's a big wardrobe." },
    { id: "a2u10.namjestaj", hr: "namještaj", en: "furniture", pos: "noun", gender: "m", icon: "🪑", exampleHr: "Namještaj je nov.", exampleEn: "The furniture is new." },
    { id: "a2u10.krevet", hr: "krevet", en: "bed", pos: "noun", gender: "m", icon: "🛏️", exampleHr: "Krevet je u spavaćoj sobi.", exampleEn: "The bed is in the bedroom." },
    { id: "a2u10.ormar", hr: "ormar", en: "wardrobe / closet", pos: "noun", gender: "m", icon: "🚪", exampleHr: "Ormar je velik.", exampleEn: "The wardrobe is big." },
    { id: "a2u10.stol", hr: "stol", en: "table", pos: "noun", gender: "m", icon: "🪵", exampleHr: "Stol je u kuhinji.", exampleEn: "The table is in the kitchen." },
    { id: "a2u10.stolica", hr: "stolica", en: "chair", pos: "noun", gender: "f", icon: "🪑", exampleHr: "Stolica je stara.", exampleEn: "The chair is old." },
  ],
  slides: [
    {
      id: "s01",
