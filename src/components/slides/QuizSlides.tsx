...
export function QuizSetSlideView({ slide, onDone }: QuizProps<QuizSetSlide>) {
  ...
  return (
    <div>
      <h2 className="text-xl font-black">🧩 {slide.title ?? "Quick check"}</h2>
      ...
      {!checked ? (
        <button
          ...
          className="mt-4 w-full rounded-xl bg-stone-900 py-2.5 font-bold text-white disabled:opacity-40"
        >
          Check all
        </button>
      ) : (
...
export function TypeSlideView({ slide, onDone }: QuizProps<TypeSlide>) {
  ...
  return (
    <div>
      <h2 className="text-xl font-black">{slide.prompt}</h2>
      ...
      {result === null ? (
        <button
          ...
          className="mt-4 rounded-xl bg-stone-900 px-5 py-2 font-bold text-white disabled:opacity-40"
        >
          Check
        </button>
      ) : (
...
export function ListenTypeSlideView({ slide, onDone }: QuizProps<ListenTypeSlide>) {
  ...
  return (
    <div>
      <h2 className="text-xl font-black">👂 Listen and type</h2>
...
export function SpeakSlideView({ slide, onDone }: QuizProps<SpeakSlide>) {
  ...
  return (
    <div>
      <h2 className="text-xl font-black">🎤 Say it out loud</h2>
...
export function MatchSlideView({ slide, onDone }: QuizProps<MatchSlide>) {
  ...
  return (
    <div>
      <h2 className="text-xl font-black">{slide.prompt ?? "Match the pairs"}</h2>
...
export function FillSlideView({ slide, onDone }: QuizProps<FillSlide>) {
  ...
  return (
    <div>
      <h2 className="text-xl font-black">Complete the sentence</h2>
...
export function ReorderSlideView({ slide, onDone }: QuizProps<ReorderSlide>) {
  ...
  return (
    <div>
      <h2 className="text-xl font-black">Build the sentence</h2>
        ...
        <div className="flex flex-wrap gap-2">
          {chosen.map((w, i) => (
            <button
              ...
              className="rounded-lg bg-stone-900 px-3 py-1.5 font-semibold text-white"
            >
              {w}
            </button>
          ))}
